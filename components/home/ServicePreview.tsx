            ...
            <div className="container mx-auto px-4 md:px-6">
                                ...
                                <Link href={`/${service.slug}/`} className="flex flex-col h-full relative group">
                                    ...
                                    <div className="p-4 flex flex-col flex-grow text-center">
                                        ...
                                        <div className="service--title mb-2 min-h-[48px] flex items-center justify-center">
                                            <span className="text-[#01bbbf] font-bold text-lg leading-tight uppercase">
                                                {service.title}
                                            </span>
                                        </div>
                                        ...
                                        <div className="mt-auto">
                                            <div className="services__price text-[#202020] text-[1.5rem] font-medium my-[8%]">
                                                {service.price}
                                            </div>
                                            <span
                                                className="indexServices_button inline-block text-white bg-[#01bbbf] uppercase text-[13px] font-medium py-2.5 px-4 rounded-[2px] transition-colors group-hover:bg-[#202020] hover:text-white"
                                            >
                                                Подробнее
                                            </span>
                                        </div>
                ...
                <div className="row mt-10 text-center">
                    <div className="col-xs-12 mt40 tac">
                        <Link href="/services/" className="inline-flex items-center text-[#202020] hover:text-[#01bbbf] font-medium transition-colors group">
                            <span className="border-b border-gray-300 group-hover:border-[#01bbbf] pb-0.5 link_underline">Все услуги</span>
